...
> **Real-time Antigravity (Gemini) Token Quota Monitoring, Upstash Redis Cloud Sync & Weekly Multiplier Auto-Calibration System**  
...
2. **☁️ Upstash Redis Cloud Sync (Work ↔ Home PC)**:
...
3. **🎯 Weekly Multiplier Auto-Calibration & Manual Tuning**:
...
4. **🌱 New Weekly Cycle Reset & First Usage Auto-Tracker**:
...
5. **⏰ Easy Weekly Reset Time Calculator**:
...
6. **🚦 3-Tier Status System & Dynamic Tray Badge**:
...
7. **🚀 1.48 MB Memory Footprint Optimization**:
...
8. **📂 Categorized Daily Rolling Logs**:
   - /logs/usage/: Real-time 5h/weekly quota logs
   - /logs/speed/: 5-hour consumption speed, reset countdown, and exhaustion predictions
...
2. Create or edit config.json with your **Upstash credentials** (see guide below).
...
| daily_reset_time | "00:00" | Daily baseline time in 24-hour format (HH:mm) |
